...
${delivery_name}            xpath=//input[@id="form_item_name"]
${delivery_surname}         xpath=//input[@id="form_item_surName"]
${delivery_address}         xpath=//input[@id="form_item_address"]
${delivery_phone}           xpath=//input[@id="form_item_phone"]
